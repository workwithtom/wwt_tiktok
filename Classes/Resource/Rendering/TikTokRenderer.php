...
namespace WorkWithTom\WwtTiktok\Resource\Rendering;
...
class TikTokRenderer implements FileRendererInterface
{
    ...
    {
        $src = $this->createTikTokCode($options, $file);
        return $src;
    }
     ...
     * @return string
     */
    protected function createTikTokCode(array $options, FileInterface $file)
    {
        $videoId = $this->getVideoIdFromFile($file);
        $video = GeneralUtility::getUrl(sprintf(
